...
def get_version():
    init_contents = (project_root / "lua_imports/__init__.py").read_text(
        encoding="utf-8"
    )
...
setup(
    name="lua_imports",
    version=get_version(),
    packages=find_packages(include=("lua_imports", "lua_imports.*")),
    install_requires=get_requirements(),
    setup_requires=["wheel"],
    author="Robert Wright",
    author_email="madman.bob@hotmail.co.uk",
    description="Import Lua modules directly from within Python",
    long_description=get_long_description(),
    long_description_content_type="text/markdown",
    url="https://github.com/madman-bob/python-lua-imports",
    license="MIT",
    classifiers=[
